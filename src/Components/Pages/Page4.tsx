    ...
    <section className="w-full h-auto bg-[#303B97] flex flex-col items-center justify-center py-8">
      <div className="w-full mx-auto px-4 flex flex-col items-center md:py-0">
        ...
        <div className="flex gap-4 mb-8">
          <button
            className={`px-6 md:px-13 py-2 md:py-4 rounded-full font-semibold text-lg shadow transition border-2 focus:outline-none ${
              activeTab === "Buyers"
                ? "bg-white text-black "
          ...
          <button
            className={`px-6 md:px-13 py-2 md:py-4 rounded-full font-semibold text-lg shadow transition border border-white focus:outline-none ${
              activeTab === "Sellers"
        ...
        {activeTab === "Sellers" && (
          <div className="w-full flex flex-col md:flex-row justify-between items-stretch gap-6">
            ...
            <div className="flex flex-col items-center rounded-2xl p-6 pb-2 md:pb-6 w-full md:max-w-[32%]">
              ...
              <p className="text-white text-center text-lg md:text-xl font-medium">
                Turn your idle items into a side hustle, right <br /> from your
                home.
              </p>
            </div>
          </div>
